...
locals {
  vm_name = "windows-server-2022-${lower(var.build_edition)}"
...
source "proxmox-iso" "windows-server-2022" {
  ...
  tags                 = "Windows;Windows-Server;Windows-Server-2022;Windows-Server-2022-${var.build_edition}"
  template_description = "Windows Server 2022 ${var.build_edition}, Built ${timestamp()}"
